...
Думаю о том, как можно автоматизировать рутину (Python, Cypress).<br>

Пишу подробную, но в тоже время простую и понятную документацию, чтобы вся команда понимала суть и экономила свое время.<br>

★ Что для меня важно в работе:<br>

Ищу место, где можно расти: от ручного тестирования к автоматизации.<br>

Когда работадатель предоставляет тебе возможность развиваться и учиться тому, что нужно для проекта.<br>

Ценю честность, открытость, поддержку и ответственность в команде.<br>
