## Здравствуй! 😉
Меня зовут Катерина, я QA Engineer
...
Думаю о том, как можно автоматизировать рутину (Python, Cypress)

Пишу подробную, но в тоже время простую и понятную документацию, чтобы вся команда понимала суть и экономила свое время


⭐ Что для меня важно в работе:<br>

Ищу место, где можно расти: от ручного тестирования к автоматизации

Когда работадатель предоставляет тебе возможность развиваться и учиться тому, что нужно для проекта

Ценю честность, открытость, поддержку и ответственность в команде
...
протестировала десктопную версию сайта в браузерах:
